    ...
    <div class="card card-outline card-navy shadow rounded-0">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <button class="btn btn-sm btn-primary btn-flat" id="edit_project"><i class="fa fa-edit"></i> Editar detalles</button>
                <button class="btn btn-sm btn-danger btn-flat" id="delete_project"><i class="fa fa-trash"></i> Eliminar detalles</button>
                <?php endif; ?>
...
<script>
    $(function() {
        $('#edit_project').click(function(){
			uni_modal("Actualizar detalles del proyecto","projects/manage_project.php?id=<?= isset($id) ? $id : '' ?>")
		})
        $('#delete_project').click(function(){
			_conf("¿Estás seguro de eliminar este proyecto?","delete_project",["<?= isset($id) ? $id : '' ?>"])
		})
        $('#close_project').click(function(){
			_conf("¿Estás seguro de cerrar este proyecto?","close_project",["<?= isset($id) ? $id : '' ?>"])
		})
