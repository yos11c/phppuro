...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-6">
            <dl>
                <dt class="text-muted">Código del empleado</dt>
                <dd class='pl-4 fs-4 fw-bold'><?= isset($code) ? $code : 'N/A' ?></dd>
                <dt class="text-muted">Nombre del empleado</dt>
        ...
        <div class="col-md-6">
            <dl>
                <dt class="text-muted">Departamento</dt>
                <dd class='pl-4 fs-4 fw-bold'><?= isset($department) ? $department : 'N/A' ?></dd>
                <dt class="text-muted">Posición</dt>
