...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Tiempo de empleado asignado por proyecto
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Tiempo trabajado del empleado para <?= $proj ?></b></h3>
			...
			<table class="table table-bordered table-hover table-striped">
				...
				<tbody>
                    ...
                    <?php if($qry->num_rows <= 0): ?>
                        <tr>
                            <th colspan="5"><center>Sin datos</center></th>
                        </tr>
                    <?php endif; ?>
				</tbody>
				<tfoot>
					<tr class="bg-lightblue text-light bg-opacity-50">
						<th colspan="4" class="text-right"> Tiempo total trabajado</th>
...
<script>
	$(document).ready(function(){
       ...
       $('#print').click(function(){
		   ...
		   var _h = $('head').clone()
		   var _el = $('<div>')
		   _h.find("title").text("Reporte de tiempo trabajado por proyecto por empleado - Vista de impresión")
