...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		<h3 class="card-title">Reporte de tiempo trabajado por proyecto por empleado
</h3>
        ...
        <div class="container-fluid">
			<div class="row">
				...
				<div class="col-8">
					...
					<h3 class="text-center"><b>Reporte de tiempo trabajado del empleado por proyecto</b></h3>
