...
<div class="container-fluid">
    <form action="" id="work_type-form">
        ...
        <div class="form-group">
            <label for="name" class="control-label">Nombre del tipo de trabajo</label>
            <input type="text" name="name" id="name" class="form-control form-control-border" placeholder="Ingrese el nombre del tipo de trabajo" value ="<?php echo isset($name) ? $name : '' ?>" required>
        </div>
        <div class="form-group">
