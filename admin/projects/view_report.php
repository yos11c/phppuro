    ...
    <div class="row">
        <div class="col-md-6">
            <dl>
                ...
                <dt class="text-muted">Fecha y hora desde</dt>
        ...
        <div class="col-md-6">
            <dl>
                <dt class="text-muted">Fecha y hora hasta</dt>
...
<script>
    $(function(){
        ...
        $('#delete_report').click(function(){
			_conf("¿Estás seguro de eliminar este reporte de forma permanente?","delete_report",["<?= isset($id) ? $id : '' ?>"])
		})
