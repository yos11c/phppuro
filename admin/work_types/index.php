...
<script>
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal("Detalles del tipo de trabajo","work_types/view_work_type.php?id="+$(this).attr('data-id'))
		})
        $('.edit_data').click(function(){
			uni_modal("Actualizar detalles del tipo de trabajo","work_types/manage_work_type.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar este tipo de trabajo de forma permanente?","delete_work_type",[$(this).attr('data-id')])
		})
