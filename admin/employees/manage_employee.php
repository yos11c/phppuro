    ...
    <form id="employee-form" action="" method="post">
        ...
        <div class="row">
            <div class="form-group col-md-4">
                ...
                <small class="mx-2">Código de empleado</small>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
                <input type="text" name="firstname" id="firstname" placeholder="Joel" autofocus required class="form-control form-control-sm form-control-border" value="<?= isset($firstname) ? $firstname :"" ?>">
            ...
            <div class="form-group col-md-4">
                <input type="text" name="lastname" id="lastname" placeholder="Perez" required class="form-control form-control-sm form-control-border" value="<?= isset($lastname) ? $lastname :"" ?>">
                <small class="mx-2">Apellidos</small>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-4">
            ...
            <div class="form-group col-md-4">
                <input type="text" name="department" id="department" placeholder="Informática" required class="form-control form-control-sm form-control-border"  value="<?= isset($department) ? $department :"" ?>">
                <small class="mx-2">Departamento</small>
            </div>
            <div class="form-group col-md-4">
                <input type="text" name="position" id="position" placeholder="Desarrollador web" required class="form-control form-control-sm form-control-border" value="<?= isset($position) ? $position :"" ?>">
                <small class="mx-2">Posición</small>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-10">
                <input type="email" name="email" id="email" placeholder="tareacompleto@gmail.com" required class="form-control form-control-sm form-control-border" value="<?= isset($email) ? $email :"" ?>">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <button class="btn btn-sm btn-light border rounded-0" type="button" id="generate-btn">Generar</button>
            </div>
        </div>
