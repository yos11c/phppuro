							...
							<td align="center">
								 <button type="button" class="btn btn-flat btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-trash text-danger"></span> Eiminar</a>
				                  </div>
							</td>
						</tr>
					<?php endwhile; ?>
...
<script>
	$(document).ready(function(){
		$('#create_new').click(function(){
			uni_modal("Agregar nuevo empleado","employees/manage_employee.php",'mid-large')
		})
		$('.edit_data').click(function(){
			uni_modal("Actualizar detalles del empleado","employees/manage_employee.php?id="+$(this).attr('data-id'),'mid-large')
		})
		$('.delete_data').click(function(){
			_conf("¿Estás seguro de eliminar a este Empleado de forma permanente?","delete_employee",[$(this).attr('data-id')])
		})
		$('.view_data').click(function(){
			uni_modal("Detalles del empleado","employees/view_employee.php?id="+$(this).attr('data-id'))
		})
