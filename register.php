      ...
      <div class="d-flex w-100 h-100 justify-content-center align-items-center">
        <div class="card col-lg-10 card-outline card-primary rounded-0 shadow">
          <div class="card-header rounded-0">
            <h4 class="text-dark text-center"><b>Crea una cuenta nueva</b></h4>
          </div>
            ...
            <form id="registration-frm" action="" method="post">
              ...
              <div class="row">
                  <div class="form-group col-md-4">
                      <input type="text" name="firstname" id="firstname" placeholder="Joel" autofocus required class="form-control form-control-sm form-control-border">
                  ...
                  <div class="form-group col-md-4">
                      <input type="text" name="lastname" id="lastname" placeholder="perez" required class="form-control form-control-sm form-control-border">
              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-4">
                      ...
                      <small class="mx-2">Cumpleaños</small>
                  </div>
                  <div class="form-group col-md-4">
                      <input type="text" name="contact" id="contact" placeholder="+51xxxxxxxxx" required class="form-control form-control-sm form-control-border">
                      <small class="mx-2">Número de contacto</small>
                  </div>
              </div>
              <div class="row">
                  <div class="form-group col-md-12">
                      <small class="mx-2">Dirrección</small>
                      <textarea name="address" id="address" rows="3" class="form-control form-control-sm rounded-0"></textarea>
                  </div>
              </div>
              <div class="row">
                    <div class="form-group col-md-10">
                      <input type="email" name="email" id="email" placeholder="tareacompleto@gmail.com" required class="form-control form-control-sm form-control-border">
